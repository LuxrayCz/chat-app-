...
const Layout = async ({ children }: layoutProps) => {
  ...
  console.log(friends);
  const unseenRequestCount = ((await fetchRedis("smembers", `user:${session.user.id}:incoming:friend_requests`)) as User[]).length;
  return (
    <div className="w-full flex h-screen ">
      ...
      <div className="md:flex hidden h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white p-6">
        ...
        <nav className="flex flex-1 flex-col">
          <ul role="list" className="flex flex-1 flex-col gap-y-7">
            ...
            <li className="text-xs font-semibold leading-6 text-gray-400">Overview</li>
            <li>
